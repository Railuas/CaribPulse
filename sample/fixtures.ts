export const samplePoint = { lat: 17.3, lon: -62.73, name: "St. Kitts & Nevis" };
...
export const sampleAlerts = [
  { title: "Heat Advisory for coastal plain", desc: "High temperatures and humidity could cause heat stress during the afternoon hours.", severity: "advisory" as const, source: "Met Service" },
  { title: "Strong winds near squalls", desc: "Gusts 35–45 km/h possible in showers; small craft should exercise caution.", severity: "watch" as const, source: "Marine Advisory" },
];
